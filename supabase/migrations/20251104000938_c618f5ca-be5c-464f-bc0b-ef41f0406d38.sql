-- CRITICAL FIX: Correct followed_id to following_id bug
...
BEGIN
  -- Get total available posts count with proper error handling
...
EXCEPTION
  WHEN OTHERS THEN
    RAISE WARNING 'Error in get_feed_optimized: %', SQLERRM;
    RETURN;
END;
$$;
